...
public interface ProjectsApi {
    @ApiOperation(value = "project 정보 조회", nickname = "projectsGet", notes = "", response = Project.class, responseContainer = "List", tags={ "projects", })
    @ApiResponses(value = {
    ...
    ResponseEntity<List<Project>> projectsGet() throws Exception;
